# main.py — updated imports at top
import os
import sqlite3
...
from database import init_db, get_all_spots
...
class FishNavApp(App):
    ...
    def build_screens(self):
        ...
        sm.add_widget(MapScreen(name='map'))       # ← now from map_screen.py
        sm.add_widget(SpotsScreen(name='spots'))
        sm.add_widget(WeatherScreen(name='weather'))
        # sm.add_widget(DownloadScreen(name='download'))
        sm.add_widget(MapScreen(name='download'))
        return sm
